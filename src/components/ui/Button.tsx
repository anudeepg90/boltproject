...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    outline: 'border border-slate-300 bg-white text-slate-700 hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 focus:ring-slate-500',
